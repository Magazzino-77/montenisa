...
```bash
SHUTTER_CONTENT_ENDPOINT=https://<m77-shutter-domain>/api/shutter/public/montenisa/content?page=home&locale=it
...
This repo is Shutter-discoverable because it includes:

```text
shutter/schema.json
shutter/content/home.it.json
```

When the repo is pushed to Magazzino-77, the Shutter dashboard can discover it automatically and seed the editable page content from `shutter/content/home.it.json`.
